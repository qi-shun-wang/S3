...
//    func delete(bucket: String, on container: Container) throws -> Future<Void>
    ...
    /// Get list of objects
    func list(bucket: String, region: Region?, headers: [String: String], prefix: String?, delimiter: String?, continuationToken: String?, on container: Container) throws -> Future<BucketResults>
